        ...
        <div className="flex flex-col items-center text-center md:flex-row md:text-left md:items-start md:space-x-10">
          <div className="md:flex-1 pb-10 md:pb-0 gap-y-6 flex flex-col items-center md:items-start">
            <h1 className="text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl">
              Welcome to <span className="text-indigo-500 hover:text-indigo-400 block transition-all duration-150">Intelligent Notes App</span>
            </h1>
            <p className="mt-4 max-w-lg text-xl">
              Here at Intelligent Notes App, we believe in empowering individuals and organizations to reach their fullest potential through innovative note-taking solutions powered by AI.
            </p>
          </div>
          <div className="flex flex-col items-center justify-center gap-6 md:flex-1">
            ...
            {/* Primary CTA Button */}
            <Link href="/login" className="z-10 rounded-md bg-indigo-600 px-6 py-3 text-lg font-semibold text-white shadow-md transition duration-200 hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:ring-opacity-50">
              Get Started
            </Link>
