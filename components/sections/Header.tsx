...
const Header = async () => {
  ...
  return (
    <header className="relative flex h-24 w-full px-3 sm:px-8 items-center justify-between bg-popover shadow-sm">
      ...
      <Link href={user ? "/" : "/home"} className="flex items-center gap-2 px-3 md:px-4 mx-1 md:mx-2 my-auto w-2xl ml-2 md:ml-3 text-indigo-500 hover:text-indigo-400 transition-all duration-150" >
